                                    ...
                                    <li>
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    <asp:Button ID="Sign_in" runat="server" CssClass="btn btn-primary btn-block" Text="Sign In" OnClick="Sign_in_Click" />
                                                </div>
                                                <div class="checkbox">
                                                    <label>
            ...
            <!--tax button-->
                ...
                <div class="container">
                    <div class="calculate">
                        ...
                        <center><asp:Label ID="Labeltxt" runat="server" visible="false" ForeColor="White" Font-Bold="true"></asp:Label></center>
